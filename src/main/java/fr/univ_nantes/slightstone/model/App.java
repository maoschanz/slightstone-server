...
public class App {
	...
	public CommandLineRunner initialisationBDD(HerosRepository hRepository, ActionsRepository aRepository, CartesRepository cRepository) {
		return (args) -> {
			...
			//Paladin
			DescripteurHeros paladin = new DescripteurHeros(ClasseHeros.PALADIN, "paladin.svg", actionSpecialePaladin);
			...
			//Guerrier
			DescripteurHeros guerrier = new DescripteurHeros(ClasseHeros.GUERRIER, "guerrier.svg", actionSpecialeGuerrier);
